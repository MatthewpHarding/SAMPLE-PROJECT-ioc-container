...
class ShowroomsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "ShowroomCell", for: indexPath) as? ShowroomCell,
            let showroom = registeredShowrooms[safe: indexPath.row] else { return UITableViewCell() }
        // decoration
