//
//  DifferentInstanceTests_Transient.swift
//  SwincyBoxTests
//
...
class DifferentInstanceTests_Transient: XCTestCase {
    ...
    override func setUpWithError() throws {
        box.register(life: .transient) { Engine(make: "BMW", model: "Sport 5000", gears: 7) as Engine }
        box.register(life: .transient) { r in
    ...
    func testThatCarInstancesAreDifferent() throws {
        ...
        XCTAssertTrue(car !== car2, "Resolved values are the same instance")
    }
