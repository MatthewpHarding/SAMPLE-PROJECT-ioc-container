...
class OnIntialisedTests_permanent: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        box.register(CrashTestDummy.self, life: .permanent) { resolver in
            return CrashTestDummy(car: SafetyTestCar(driver: nil))
        }.onInitialised { resolver, service in
            let driver = service as! CrashTestDummy
